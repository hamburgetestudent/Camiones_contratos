...
> **Nota:** La plantilla oficial de GitHub para Pull Requests se encuentra disponible en `.github/PULL_REQUEST_TEMPLATE.md`. Este archivo sirve como borrador y plantilla reutilizable para el equipo.
